...
//something wrong with resizeCanvas()
//cssHeight keeps growing by 4 pixels
function resizeCanvas() {
    ...
    var cssHeight = parseInt(cs.getPropertyValue('height'), 10) - 4;
    
//     alert("widthcs: " + cs.getPropertyValue('width') + "heightcs: " + cs.getPropertyValue('height') + "cssHeight = " + cssHeight + "\ncssWidth = " + cssWidth + "\ncanvas.width = " + canvas.width + "\ncanvas.height = " + canvas.height);
...
function redrawFunctions()  {
    this.graphFunction(function(x)  {return (x - 5) * (x - 5) - 2;});
   this.graphFunction(function(x)  {return -1 * x * x;});
   this.graphFunction(function(x)  {return 1 / x;});
   this.graphFunction(function(x)  {return -1 * Math.sin(x);});
}
...
//    windowVars = {"xMin":null, "xMax":null, "xScl":null, "yMin":null, "yMax":null, "yScl":null};
    ...
    increment = (this.xMax - this.xMin) / 100;
    ///////////////////
//    /////////////cdraw.lineWidth = 1;
